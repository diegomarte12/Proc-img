...
modelo = tf.keras.Sequential([
    ...
    tf.keras.layers.Dense(128*3, activation='relu'), # Capa oculta con 128 neuronas y función de activación ReLU
    tf.keras.layers.Dense(128*3, activation='relu'), # Capa oculta con 128 neuronas y función de activación ReLU
    tf.keras.layers.Dense(128*3, activation='relu'), # Capa oculta con 128 neuronas y función de activación ReLU
...
img_nueva = cv2.imread("3prueba.jpg", cv2.IMREAD_GRAYSCALE)
...
img_nueva = cv2.imread("7prueba.jpg", cv2.IMREAD_GRAYSCALE)
